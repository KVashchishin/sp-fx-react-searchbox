...
describe("ReactSearchBox component tests:", () => {
  ...
  before(() => {
    ...
    // mount the component.
    searchBoxComponent = mount(<ReactSearchBox customSearchLabel={searchLabel} tenantUrl={tenantUrl} enableClassicResultPage={false} absoluteUrl="" enableAllsiteSearch={false}/>);
  });
  ...
  it("Should call the correct results page uri when has searchResultsPageUrl value", () => {
    ...
    let searchBoxComponent2: any =
      mount(<ReactSearchBox customSearchLabel={searchLabel} tenantUrl={tenantUrl} enableClassicResultPage={false} absoluteUrl="" enableAllsiteSearch={false}/>);
